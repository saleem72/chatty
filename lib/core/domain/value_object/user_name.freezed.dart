...
mixin _$Username {
  ...
  UsernameValidatorError? get error => throw _privateConstructorUsedError;
...
abstract class $UsernameCopyWith<$Res> {
  ...
  @useResult
  $Res call({String value, UsernameValidatorError? error});

  $UsernameValidatorErrorCopyWith<$Res>? get error;
}
...
class _$UsernameCopyWithImpl<$Res, $Val extends Username>
  ...
  $UsernameValidatorErrorCopyWith<$Res>? get error {
    ...
    return $UsernameValidatorErrorCopyWith<$Res>(_value.error!, (value) {
...
class _$_Username extends _Username {
  _$_Username({required this.value, required this.error}) : super._();

  @override
  final String value;
  @override
  final UsernameValidatorError? error;

  @override
  String toString() {
    return 'Username(value: $value, error: $error)';
  }
...
abstract class _Username extends Username {
  factory _Username(
      ...
      required final UsernameValidatorError? error}) = _$_Username;
  _Username._() : super._();

  @override
  String get value;
  @override
  UsernameValidatorError? get error;
  @override
  @JsonKey(ignore: true)
  _$$_UsernameCopyWith<_$_Username> get copyWith =>
      throw _privateConstructorUsedError;
