...
mixin _$Email {
  ...
  EmailValidationError? get error => throw _privateConstructorUsedError;
...
abstract class $EmailCopyWith<$Res> {
  ...
  @useResult
  $Res call({String value, EmailValidationError? error});

  $EmailValidationErrorCopyWith<$Res>? get error;
}
...
class _$EmailCopyWithImpl<$Res, $Val extends Email>
  ...
  $EmailValidationErrorCopyWith<$Res>? get error {
    ...
    return $EmailValidationErrorCopyWith<$Res>(_value.error!, (value) {
...
class _$_Email extends _Email {
  _$_Email({required this.value, required this.error}) : super._();
  ...
  @override
  String toString() {
    return 'Email(value: $value, error: $error)';
  }
...
abstract class _Email extends Email {
  factory _Email(
      ...
      required final EmailValidationError? error}) = _$_Email;
  _Email._() : super._();
