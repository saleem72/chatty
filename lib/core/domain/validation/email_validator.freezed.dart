...
class __$$_InvalidFormatCopyWithImpl<$Res>
    extends _$EmailValidationErrorCopyWithImpl<$Res, _$_InvalidFormat>
...
class _$_InvalidFormat implements _InvalidFormat {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$_InvalidFormat);
  }
...
abstract class _InvalidFormat implements EmailValidationError {
  const factory _InvalidFormat() = _$_InvalidFormat;
}
